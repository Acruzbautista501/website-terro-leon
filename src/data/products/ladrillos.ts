import type { Ladrillo } from "../../interfaces/products/Ladrillos";

export const ladrillos: Ladrillo = {
    rockStoneTab: [
        {
    ...
    rockStone: [
        {
            ...
            ancho: "7cm",
            espesor: "1.50cm",
            contenido: "48 piezas individuales",
